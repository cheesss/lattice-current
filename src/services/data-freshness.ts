...
export type DataSourceId =
  ...
  | 'security_advisories' // travel / embassy / health advisories
  | 'rss'        // RSS feeds
  | 'polymarket' // Prediction markets
  | 'predictions' // Predictions feed
  | 'pizzint'    // PizzINT monitoring
  | 'glint'      // Glint intelligence stream
  ...
  | 'portwatch'      // IMF PortWatch maritime disruptions
...
const SOURCE_METADATA: Record<DataSourceId, { name: string; requiredForRisk: boolean; panelId?: string }> = {
  ...
  glint: { name: 'Glint Intelligence', requiredForRisk: false, panelId: 'map' },
  ...
  portwatch: { name: 'PortWatch Maritime', requiredForRisk: false, panelId: 'supply-chain' },
...
const INTELLIGENCE_GAP_MESSAGES: Record<DataSourceId, string> = {
  ...
  security_advisories: 'Travel and embassy advisories unavailable—risk context coverage reduced',
  ...
  glint: 'Glint intelligence unavailable—real-time geopolitical source coverage reduced',
  ...
  portwatch: 'Maritime chokepoint and disruption intelligence unavailable—PortWatch not updating',
