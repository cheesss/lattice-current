...
export const SIGNUP_URLS: Partial<Record<RuntimeSecretKey, string>> = {
  ...
  GLINT_AUTH_TOKEN: 'https://glint.trade/',
  ...
  OPENBB_API_URL: 'https://docs.openbb.co/platform/developer_guide/api',
  OPENBB_API_KEY: 'https://docs.openbb.co/platform/developer_guide/api',
};
...
export const HUMAN_LABELS: Record<RuntimeSecretKey, string> = {
  ...
  GLINT_AUTH_TOKEN: 'Glint Auth Token',
  ...
  WORLDMONITOR_API_KEY: 'Platform License Key',
  WTO_API_KEY: 'WTO API Key',
  OPENBB_API_URL: 'OpenBB API URL',
...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  {
    ...
    features: ['aiOllama', 'aiGroq', 'aiOpenAI', 'aiCodexLogin', 'aiOpenRouter'],
  },
  {
    id: 'economy',
  ...
  },
  {
    id: 'markets',
    label: 'Markets & Trade',
    features: ['finnhubMarkets', 'wtoTrade', 'openbbSignals'],
  },
  {
    id: 'security',
