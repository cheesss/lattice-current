    ...
    const html = data
      ...
      <div class="prediction-item">
        ...
        <div class="prediction-legend">
          <span class="prediction-legend-item yes">${t('components.predictions.yes')} ${yesPercent}%</span>
          <span class="prediction-legend-item no">${t('components.predictions.no')} ${noPercent}%</span>
        </div>
      </div>
    `;
      })
