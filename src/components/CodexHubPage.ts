...
export class CodexHubPage {
  ...
  constructor(options: CodexHubOptions) {
    ...
    this.overlay.innerHTML = `
      <section class="codex-hub-container" role="dialog" aria-modal="true" aria-label="Codex Hub">
        <header class="codex-hub-header">
          <div class="codex-hub-header-main">
            <h2 class="codex-hub-title">CODEX HUB</h2>
            <p class="codex-hub-subtitle">High-fidelity intelligence synthesis and source operations</p>
          </div>
          <div class="codex-hub-actions">
            <button type="button" class="codex-hub-action-btn" data-role="refresh">
        ...
        <div class="codex-stats-grid">
           <div class="codex-stat-card">
              <div class="codex-stat-label">Automation Velocity</div>
              <div class="codex-stat-value" id="statVelocity">0.0</div>
           </div>
           <div class="codex-stat-card">
              <div class="codex-stat-label">Active Investigations</div>
              <div class="codex-stat-value" id="statInvestigations">0</div>
           </div>
           <div class="codex-stat-card">
              <div class="codex-stat-label">Source Reliability</div>
              <div class="codex-stat-value" id="statReliability">0%</div>
           </div>
           <div class="codex-stat-card">
              <div class="codex-stat-label">Queue Pressure</div>
              <div class="codex-stat-value" id="statPressure">Low</div>
           </div>
        </div>

        <div class="codex-hub-main-layout">
          <div class="codex-hub-content-column">
             <section class="codex-hub-section" data-slot="visuals"></section>
             <div class="codex-hub-half-grid">
                <section class="codex-hub-section" data-slot="qa"></section>
                <section class="codex-hub-section" data-slot="ops"></section>
             </div>
          </div>
          <aside class="codex-hub-sidebar">
             <section class="codex-hub-section" data-slot="codex-ops"></section>
          </aside>
        </div>
      </section>
    `.trim();
