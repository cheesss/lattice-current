...
export class MapContainer {
  ...
  private cachedMilitaryBases: MilitaryBaseEnriched[] | null = null;
  ...
  private rehydrateActiveMap(): void {
    ...
    if (this.cachedMilitaryBases) this.setMilitaryBases(this.cachedMilitaryBases);
  ...
  public setMilitaryBases(bases: MilitaryBaseEnriched[]): void {
    this.cachedMilitaryBases = bases;
    if (this.useGlobe) { this.globeMap?.setMilitaryBases(bases); return; }
    if (this.useDeckGL) {
      this.deckGLMap?.setMilitaryBases(bases);
    } else {
      this.svgMap?.setMilitaryBases(bases);
    }
  }
