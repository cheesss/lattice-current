...
export interface RelatedClusterRef {
  id: string;
  title: string;
  score: number;
}
...
export interface ClusterRelations {
  relatedNews: RelatedClusterRef[];
  airEventMatches: number;
  maritimeEventMatches: number;
...
export interface MapLayers {
  ...
  // Aggregated intelligence density
  intelDensity: boolean;
}
