...
const WORKSPACES: WorkspaceDefinition[] = [
  {
    ...
    featuredPanels: ['investment-ideas', 'event-intelligence', 'hawkes-heatmap', 'evidence-distribution'],
  },
  {
    id: 'brief',
    label: 'Brief',
  ...
  },
  {
    ...
    featuredPanels: ['backtest-lab', 'calibration-scatter', 'alpha-decay', 'evidence-distribution'],
  },
  {
    id: 'operate',
    label: 'Operate',
