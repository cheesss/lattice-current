...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'glint-feed': { name: 'Glint Feed', enabled: true, priority: 1 },
  ...
  'signal-ridgeline': { name: 'Signal Ridge', enabled: true, priority: 2 },
};
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  intelligence: {
    ...
    panelKeys: ['cii', 'strategic-risk', 'intel', 'glint-feed', 'gdelt-intel', 'cascade'],
    variants: ['full'],
  },
  regionalNews: {
