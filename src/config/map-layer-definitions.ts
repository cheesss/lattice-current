...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  intelDensity:            def('intelDensity',            '&#11014;',  'intelDensity',             'Intel Density 3D'),
};
...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  full: [
    ...
    'ciiChoropleth', 'intelDensity', 'dayNight',
  ],
  tech: [
    'startupHubs', 'techHQs', 'accelerators', 'cloudRegions',
    'datacenters', 'cables', 'outages', 'cyberThreats',
    'techEvents', 'natural', 'fires', 'intelDensity', 'dayNight',
  ],
  finance: [
    ...
    'natural', 'cyberThreats', 'intelDensity', 'dayNight',
  ],
  happy: [
  ...
  commodity: [
    ...
    'natural', 'weather', 'outages', 'intelDensity', 'dayNight',
  ],
};
