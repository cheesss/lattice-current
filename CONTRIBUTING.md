...
7. **Update public docs** when behavior, workflows, capabilities, or release surfaces change:
...
Use the [Bug Report issue template](https://github.com/cheesss/worldmonitor/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/cheesss/worldmonitor/issues/new/choose) when available.
