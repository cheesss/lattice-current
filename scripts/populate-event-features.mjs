...
const pythonScript = path.join(scriptDir, 'populate_event_features.py');
const legacyScript = path.join(scriptDir, 'populate-event-features.legacy.mjs');
...
console.warn('[populate-event-features] Python engine not available, falling back to JS');
