...
const pythonScript = path.join(scriptDir, 'fix_time_alignment.py');
const legacyScript = path.join(scriptDir, 'fix-time-alignment.legacy.mjs');
...
console.warn('[fix-time-alignment] Python engine not available, falling back to JS');
