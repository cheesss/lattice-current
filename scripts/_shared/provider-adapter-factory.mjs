...
const PROVIDER_ADAPTER_SPECS = Object.freeze({
  ...
  taiwan_mops: {
    ...
    providerGapLabels: ['provider_gap_taiwan_mops'],
    sourceType: 'non_us_official_filing',
    suggestedAdapterScope: 'read-only Taiwan MOPS issuer filing and material information evidence collector',
    authRequired: false,
    apiKeyRequired: false,
    rateLimit: { policy: 'public MOPS pages; throttle listing/PDF fetches and cache issuer mappings' },
    allowlistFiles: [
      'scripts/_shared/external-data/taiwan-mops.mjs',
      'scripts/collect-free-external-data.mjs',
      'tests/provider-adapter-taiwan-mops.test.mjs',
      'tests/fixtures/providers/taiwan-mops/*.json',
    ],
    fixtureRequirements: [
      'Taiwan MOPS annual report fixture',
      'issuer symbol/identifier mapping fixture',
      'material information no-result fixture',
    ],
  ...
  company_ir_direct_pdf: {
    ...
    providerGapLabels: ['provider_gap_company_ir_direct_pdf'],
    sourceType: 'official_company_ir',
    suggestedAdapterScope: 'read-only allowlisted company IR direct PDF evidence collector',
    authRequired: false,
    apiKeyRequired: false,
    rateLimit: { policy: 'issuer allowlist only; max documents per issuer and timeout enforced before live use' },
    allowlistFiles: [
      'scripts/_shared/external-data/company-ir-readonly.mjs',
      'scripts/run-seed-bias-evidence-acquisition.mjs',
      'tests/company-ir-readonly.test.mjs',
      'tests/fixtures/providers/company-ir-direct-pdf/*.json',
    ],
    fixtureRequirements: [
      'allowlisted official IR PDF fixture',
      'body extraction fixture with operating bridge snippet',
      'ticker-only and stale-document rejection fixtures',
    ],
