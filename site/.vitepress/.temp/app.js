...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"World Monitor","description":"Real-time global intelligence, AI-assisted analysis, historical replay, and backtesting.","base":"/worldmonitor/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/favicon.svg","search":{"provider":"local"},"nav":[{"text":"Home","link":"/"},{"text":"Getting Started","link":"/getting-started"},{"text":"Variants","link":"/variants"},{"text":"Features","link":"/features/"},{"text":"AI & Backtesting","link":"/ai-backtesting/"},{"text":"Algorithms","link":"/algorithms"},{"text":"Architecture","link":"/architecture"},{"text":"API","link":"/api"},{"text":"Updates","link":"/updates/"},{"text":"Legal","link":"/legal/"}],"sidebar":{"/features/":[{"text":"Features","items":[{"text":"Overview","link":"/features/"},{"text":"Live Intelligence","link":"/features/live-intelligence"},{"text":"Investment & Replay","link":"/features/investment-replay"}]}],"/ai-backtesting/":[{"text":"AI & Backtesting","items":[{"text":"Overview","link":"/ai-backtesting/"}]}],"/updates/":[{"text":"Updates","items":[{"text":"Overview","link":"/updates/"},{"text":"2026-03 Docs Launch","link":"/updates/2026-03-docs-launch"}]}],"/legal/":[{"text":"Legal","items":[{"text":"Overview","link":"/legal/"},{"text":"Licensing & Content","link":"/legal/licensing"}]}],"/":[{"text":"Docs","items":[{"text":"Getting Started","link":"/getting-started"},{"text":"Variants","link":"/variants"},{"text":"Features","link":"/features/"},{"text":"AI & Backtesting","link":"/ai-backtesting/"},{"text":"Algorithms","link":"/algorithms"},{"text":"Architecture","link":"/architecture"},{"text":"API","link":"/api"},{"text":"Updates","link":"/updates/"},{"text":"Legal","link":"/legal/"},{"text":"Feature Page Template","link":"/templates/feature-template"},{"text":"Update Template","link":"/templates/update-template"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/cheesss/worldmonitor"}],"footer":{"message":"Code licensed under AGPL-3.0-only. Public docs and media follow separate content policies.","copyright":"Copyright 2024-2026 Elie Habib"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CQi8nrSu.js"));
