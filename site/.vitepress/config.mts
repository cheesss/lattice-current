...
function createNav(locale: '' | 'ko' | 'ja', labels: LocaleLabels) {
  return [
    ...
    { text: labels.showcase, link: pathFor(locale, '/showcase/globe') },
    ...
    [`${base}/showcase/`]: [
      {
        ...
        items: [
          { text: labels.globeShowcase, link: pathFor(locale, '/showcase/globe') }
        ]
      }
    ],
    [`${base}/ai-backtesting/`]: [
