...
Lattice Current는 다음이 한 화면에서 필요한 사용자를 위한 문서입니다.

- 실시간 지정학 및 시장 모니터링
- 근거 중심 AI 보조
- 그래프 및 온톨로지 탐색
- 사건에서 자산으로 이어지는 전이 분석
- 과거 의사결정 로직의 리플레이와 백테스트
...
<div class="lc-link-panel-grid">
  <div class="lc-link-panel">
    <h3>운영 흐름 이해</h3>
    <p>위 의사결정 루프를 클릭하며 각 단계에 어떤 입력과 출력이 연결되는지 보세요.</p>
    <ul>
      <li>피드 수집에서 엔티티 정규화까지</li>
      <li>credibility와 regime 점수에서 전이 엔진까지</li>
      <li>아이디어 생성에서 리플레이 기반 prior 업데이트까지</li>
    </ul>
  </div>
  <div class="lc-link-panel">
    <h3>아키텍처 이해</h3>
    <p>아키텍처 페이지에는 각 하위 시스템이 어디서 실행되고 무엇을 담당하는지 보여주는 클릭형 토폴로지가 있습니다.</p>
    <ul>
      <li><a href="/ko/architecture">아키텍처 맵 열기</a></li>
      <li><a href="/ko/features/">기능 맵 보기</a></li>
      <li><a href="/ko/ai-backtesting/">AI · 백테스트 문서 읽기</a></li>
    </ul>
  </div>
</div>
